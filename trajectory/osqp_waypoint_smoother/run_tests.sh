...
PYTHONPATH="$ROOT_DIR/vendor:$ROOT_DIR:$ROOT_DIR/runtime:$CASADI_ROOT/vendor:$CASADI_ROOT:$CASADI_ROOT/runtime:$TOPPRA_ROOT/vendor:$TOPPRA_ROOT:$TOPPRA_ROOT/runtime${PYTHONPATH:+:$PYTHONPATH}" \
